...
const ClientEducationHub = () => {
  ...
  if (loading) {
    return (
      <div className="p-6 flex items-center justify-center min-h-[400px] bg-[#0a0a0a]">
  ...
  if (selectedArticle) {
    return (
      <div className="min-h-screen bg-[#0a0a0a]" data-testid="client-education-article">
        <div className="max-w-3xl mx-auto px-4 py-8">
          <Button variant="ghost" onClick={() => setSelectedArticle(null)} className="mb-6 text-gray-400 hover:text-white hover:bg-white/10">
          ...
          <Card className="mt-6 bg-orange-500/10 border-orange-500/20">
            <CardContent className="p-6">
              <h3 className="font-medium text-orange-400 mb-2">Still have questions?</h3>
  ...
  if (selectedCategory) {
    ...
    if (selectedCategory.id === 'glossary') {
      return (
        <div className="min-h-screen bg-[#0a0a0a]" data-testid="client-education-glossary">
          <div className="max-w-3xl mx-auto px-4 py-8">
            <Button variant="ghost" onClick={() => setSelectedCategory(null)} className="mb-6 text-gray-400 hover:text-white hover:bg-white/10">
              <ArrowLeft className="w-4 h-4 mr-2" /> Back
            </Button>

            <div className="mb-6">
              <h1 className="text-2xl font-bold text-zinc-200 mb-2">Insurance Glossary</h1>
              <p className="text-zinc-400">Common terms explained in plain language</p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/[0.05] border border-white/10 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500"
              />
            </div>

            <div className="space-y-4">
              {filteredGlossary.map((term) => (
                <Card key={term.id} className="bg-[#1a1a1a] border-white/10">
                  <CardContent className="p-4">
                    <h3 className="font-semibold text-white mb-1">{term.term}</h3>
                    <p className="text-zinc-400 text-sm">{term.definition}</p>
                    {term.category && (
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a]" data-testid="client-education-category">
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-bold text-zinc-200">{category?.name}</h1>
          ...
          <div className="space-y-4">
            {categoryArticles.map((article) => (
              <Card
                key={article.id}
                className="cursor-pointer bg-[#1a1a1a] border-white/10 hover:border-orange-500/40 transition-all"
  ...
  // Main Hub View
  return (
    <div className="min-h-screen bg-[#0a0a0a]" data-testid="client-education-hub">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-600 to-orange-500 text-zinc-200">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
          {categories.map((category) => (
            <Card
              key={category.id}
              className="cursor-pointer hover:border-orange-500/40 transition-all hover:-translate-y-1 bg-[#1a1a1a] border-white/10"
              onClick={() => setSelectedCategory(category)}
            >
              <CardContent className="p-6 text-center">
                <div className="w-14 h-14 bg-orange-500/20 rounded-2xl flex items-center justify-center text-orange-400 mx-auto mb-4">
                  {getCategoryIcon(category.icon)}
                </div>
                <h3 className="font-semibold text-zinc-200 mb-1">{category.name}</h3>
        ...
        {/* Quick Links */}
        <div className="mb-12">
          <h2 className="text-lg font-semibold text-white mb-4">Most Helpful</h2>
            ...
            {articles.slice(0, 4).map((article) => (
              ...
              >
                <CardContent className="p-4 flex items-center gap-4">
                  <div className="w-10 h-10 bg-white/[0.05] rounded-lg flex items-center justify-center text-orange-400">
          ...
          <div className="mb-12">
            ...
            {myQuestions.length > 0 ? (
              <div className="space-y-3">
                {myQuestions.map((q) => (
                  <Card key={q.id} className="bg-[#1a1a1a] border-white/10">
                    <CardContent className="p-4">
        ...
        {/* Contact Banner */}
        <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-zinc-200">
          <CardContent className="p-6 text-center">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-white/[0.05] border border-white/10 rounded-lg text-white focus:ring-2 focus:ring-orange-500"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-white/[0.05] border border-white/10 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500"
                  rows={4}
