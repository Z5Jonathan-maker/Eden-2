...
const TestResultsList = ({ testResults }) => {
  ...
  return (
    <Card className="bg-zinc-900 border-zinc-700/50">
      <CardHeader>
        <CardTitle className="text-zinc-100">Test Results</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          {testResults.map((result) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-zinc-500">{result.duration}</span>
              </div>
            </div>
          ))}
        </div>
...
const EmptyState = ({ onRunTests }) => (
  <Card className="bg-zinc-900 border-zinc-700/50">
    <CardContent className="p-12 text-center">
      <Zap className="w-16 h-16 text-zinc-300 mx-auto mb-4" />
      <h3 className="text-xl font-semibold text-zinc-100 mb-2">Ready to Test</h3>
...
export const TestsTab = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-zinc-900 border-zinc-700/50">
        <CardHeader>
          <CardTitle className="text-zinc-100">Test Configuration</CardTitle>
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            <select
              ...
              className="flex-1 p-2 bg-zinc-800 border border-zinc-600 rounded-lg text-zinc-100 focus:ring-2 focus:ring-blue-500"
            >
