...
export const STATUSES = {
  ...
  not_home: { label: 'Not Home', color: '#FBBF24', bgClass: 'bg-yellow-400', icon: Home, key: 'NH' },
  not_interested: { label: 'Not Interested', color: '#EF4444', bgClass: 'bg-red-500', icon: X, key: 'NI' },
  callback: { label: 'Callback', color: '#8B5CF6', bgClass: 'bg-purple-500', icon: Phone, key: 'CB' },
  appointment: { label: 'Appointment', color: '#3B82F6', bgClass: 'bg-blue-500', icon: Calendar, key: 'AP' },
