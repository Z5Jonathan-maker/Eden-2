      ...
      <main className="max-w-4xl mx-auto px-4 py-6 sm:py-8">
                ...
                {STAGES.map((stage, idx) => {
                  ...
                  return (
                    <div key={stage.key} className="flex flex-col items-center" style={{ width: '20%' }}>
                      ...
                      <p className={`mt-3 text-sm font-medium text-center ${isCurrent ? 'text-orange-600' : 'text-gray-600'}`}>
                        {stage.label}
                      </p>
        ...
        <footer className="mt-8 text-center">
          ...
          <p className="text-xs text-gray-400 mt-1">
            Last updated: {claim?.last_client_update_at ? new Date(claim.last_client_update_at).toLocaleDateString() : 'Recently'}
          </p>
        </footer>
      </main>
    </div>
